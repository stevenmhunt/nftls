...
const { resolveCertificateChain } = require('../../certificateChains');
...
function getHelpText() {
    return 'Resolves the values of a certificate chain.';
}
...
async function helpCommand() {
    ...
    console.log('\nUsage:');
    console.log('     nftls-lookup resolve <file>');
...
async function defaultCommand(args) {
    ...
    const { chain, status } = await withProgress(
        () => resolveCertificateChain(context, args.target, { cache }),
